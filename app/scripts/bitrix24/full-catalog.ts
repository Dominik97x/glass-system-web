...
export class Bitrix24FullCatalogManager {
  ...
  writeSourceReport(): FullCatalogSourceReport {
    ...
    const report: FullCatalogSourceReport = {
      ...
      notes: [
        "Katalog D4 jest generowany z published-pricing.generated.json i odpowiada produktom website+crm.",
        "Szkło dachowe dla długości 550/600 cm pozostaje wyłączone zgodnie z availability.roofGlass=false.",
        "Pozycje wyłącznie CRM, które nie mają zatwierdzonych cen w snapshotcie publikacyjnym (np. LED RGB CCT i zabieraki), nie są automatycznie importowane w D4.0.",
